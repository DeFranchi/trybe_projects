...
let tech1 = document.querySelector(".container")
...
box.addEventListener("input", writeTech)


function writeTech (event2){

    let first = document.getElementsByClassName("tech")

    first.innerText = box.value
...
let click2 = document.getElementById("my-spotrybefy")
click2.addEventListener('dblclick', changePage)
